...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (context) => Api1()),
        ChangeNotifierProvider(create: (context) => Api2()),
        ChangeNotifierProvider(create: (context) => Getapi1()),
        ChangeNotifierProvider(create: (context) => Getapi2())
      ],
      child: MaterialApp(
